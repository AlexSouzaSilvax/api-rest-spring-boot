...
<<<<<<< HEAD
    ...
    public @ResponseBody
    String addNewUser(@RequestParam String nome, @RequestParam String email) {
    ...
    public List<Carros> listaCaminhao() {
        ...
        Carros c1 = new Carros("2", "", "", "", "", "", "");
        Carros c2 = new Carros("3", "", "", "", "", "", "");
        Carros c3 = new Carros("4", "", "", "", "", "", "");
        Carros c4 = new Carros("5", "", "", "", "", "", "");
        Carros c5 = new Carros("6", "", "", "", "", "", "");
...
>>>>>>> 0b0a721e7bed5c219af1930d6efb241154ef77af
}
